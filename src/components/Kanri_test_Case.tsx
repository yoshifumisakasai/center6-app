...
import Kanri_Firebase_testCase_level1 from "./Kanri_Firebase_testCase_level1";
import Kanri_Firebase_testCase_level2 from "./Kanri_Firebase_testCase_level2";
import Kanri_Firebase_testCase_level3 from "./Kanri_Firebase_testCase_level3";
const Kanri_test_Case: FC = () => {
                    ...
                    <Flex direction="column">
                        ...
                        <Tabs>
                            ...
                            <TabPanels>
                                ...
                                <TabPanel>
                                    <Kanri_Firebase_testCase_level1 />
                                </TabPanel>


                                <TabPanel>
                                    <Kanri_Firebase_testCase_level2 />
                                </TabPanel>


                                <TabPanel>
                                    <Kanri_Firebase_testCase_level3 />
                                </TabPanel>
...
export default Kanri_test_Case;