    ...
    useEffect(() => {
        ...
        getDoc(usersCollectionRef1).then((documentSnapshot) => {
            if (documentSnapshot.exists()) {
                ...
                console.log('shouldScrollToTop(FrontEndResultコンポ）', front_language1.values);
            }
        });
        console.log('shouldScrollToTop([再レンダリングなし]]FrontEndResultコンポーネント）', front_language1.values);
