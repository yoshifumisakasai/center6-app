                        ...
                        <Tabs>
                            ...
                            <TabPanels>
                                <TabPanel>
                                    ...
                                    <CheckboxGroup >
                                        <Checkbox value="1" onChange={check_level_1}>(CSS)Library</Checkbox>
                                        <br />
                                        <Checkbox value="2" onChange={check_level_1}>CSS-In-Js</Checkbox>
                                        <br />
                                        <Checkbox value="3" onChange={check_level_1}>Tailland-jsが書ける</Checkbox>
                                        <br />
                                        <Checkbox value="3" onChange={check_level_1}>Styled componentsを理解している</Checkbox>
                                        <br />
                                        <Checkbox value="3" onChange={check_level_1}>JSX形式でコーディングできる</Checkbox>
                                        <br />
                                        <Checkbox value="3" onChange={check_level_1}>ノーマルInline スタイル</Checkbox>
                                    </CheckboxGroup>
                                    <Button
                                        onClick={next}
                                        colorScheme="pink"
