...
function Kanri_Firebase_testCase_level2() {
    ...
    const handleSubmit = async (event: any) => {
        ...
        const userDocumentRef1 = doc(db, 'kanri_test_case', 'level_2');
        if (input1 === "") {
        } else {
        ...
        const usersCollectionRef1 = doc(db, 'kanri_test_case', 'level_2');
    ...
    const changeUser = async (name: any) => {
        ...
        const ref = doc(db, 'kanri_test_case', selectedOption);
        if (level_1 === "") {
        } else {
            for (let i = 0; i < level_1.length; i++) {
                await updateDoc(ref,
...
export default Kanri_Firebase_testCase_level2;