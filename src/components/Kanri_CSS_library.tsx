...
import Kanri_Firebase_CSS_level1 from "./Kanri_Firebase_CSS_level1";
import Kanri_Firebase_CSS_level2 from "./Kanri_Firebase_CSS_level2";
import Kanri_Firebase_CSS_level3 from "./Kanri_Firebase_CSS_level3";
const Kanri_CSS_library: FC = () => {
                    ...
                    <Flex direction="column">
                        ...
                        <Tabs>
                            ...
                            <TabPanels>
                                ...
                                <TabPanel>
                                    <Kanri_Firebase_CSS_level1 />
                                </TabPanel>


                                <TabPanel>
                                    <Kanri_Firebase_CSS_level2 />
                                </TabPanel>


                                <TabPanel>
                                    <Kanri_Firebase_CSS_level3 />
                                </TabPanel>
...
export default Kanri_CSS_library;