...
function Kanri_Firebase_CSS_level3() {
    ...
    const handleSubmit = async (event: any) => {
        ...
        const userDocumentRef1 = doc(db, 'front_library', 'level_3');
        if (input1 === "") {
        } else {
    ...
    return (
        ...
        <Box m={4}>
            <form onSubmit={handleSubmit}>
                {/* 名前 */}
                <FormControl mb={5}>
                    <FormLabel htmlFor='level_1'>level-3</FormLabel>
                    <Input
...
export default Kanri_Firebase_CSS_level3;