...
function Kanri_Firebase_CSS_level1() {
    ...
    const handleSubmit = async (event: any) => {
        ...
        const userDocumentRef1 = doc(db, 'front_library', 'level_1');
        if (input1 === "") {
        } else {
        ...
        const usersCollectionRef1 = doc(db, 'front_library', 'level_1');
...
export default Kanri_Firebase_CSS_level1;